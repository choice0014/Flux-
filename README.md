...
| 모듈 | 주요 기능 |
| :--- | :--- |
| **`gui`** | 메시지 박스 팝업, 윈도우 창 생성, 이벤트 루프 |
| **`system`** | OS 쉘 실행, 플랫폼 확인, 환경 변수 읽기, 종료 |
| **`console`** | 화면 초기화, 텍스트 색상 변경, 커서 조작, 창 제목 설정 |
| **`file`** | 파일 읽기/쓰기, 존재 확인, 디렉토리 생성/삭제, 크기 확인 |
...
---
**flux +**는 계속해서 진화하고 있습니다. 더 빠른 성능을 위해 바이트코드 VM 도입이 예정되어 있습니다.
